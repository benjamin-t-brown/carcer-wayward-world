// import { GameEventChildExec, SENode } from '../../types/assets';
...
//   constructor(seNode: GameEventChildExec, ctx: CanvasRenderingContext2D) {
//     super(seNode);
//     this.p = seNode.p;
...
//     const nodeHeight = this.height * scale;

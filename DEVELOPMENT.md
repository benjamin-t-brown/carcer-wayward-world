...
Game strings use `TRANSLATE("...")` from sdl2w (`lib/sdl2w/L10n.h`). Translation files are generated by **L10nScanner**, a tool built from the [sdl2w](https://github.com/benjamin-t-brown/sdl2w) repo (cloned next to this project as `../sdl2w` when you build).

...
$(OBJDIR)/carcer.actions.combat.o: actions/combat/combat.cppm $(OBJDIR)/carcer.actions.combat-CharacterSetSpriteIndexOffset.o $(OBJDIR)/carcer.actions.combat-DoCPUCombatTurn.o $(OBJDIR)/carcer.actions.combat-DoCombatAction.o $(OBJDIR)/carcer.actions.combat-DoCombatActionCompletion.o $(OBJDIR)/carcer.actions.combat-EndCombat.o $(OBJDIR)/carcer.actions.combat-GoNextCombatTurn.o $(OBJDIR)/carcer.actions.combat-ModifyAP.o $(OBJDIR)/carcer.actions.combat-ModifyHP.o $(OBJDIR)/carcer.actions.combat-MoveCharacter.o $(OBJDIR)/carcer.actions.combat-PerformCharacterDefeated.o $(OBJDIR)/carcer.actions.combat-PerformMeleeAttack.o $(OBJDIR)/carcer.actions.combat-PerformSpellCast.o $(OBJDIR)/carcer.actions.combat-RemoveCharacterFromMap.o $(OBJDIR)/carcer.actions.combat-SetActiveCombatCharacter.o $(OBJDIR)/carcer.actions.combat-StartCombat.o | $(OBJDIR)

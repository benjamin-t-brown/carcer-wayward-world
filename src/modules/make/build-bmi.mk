...
$(OBJDIR)/carcer.actions.combat-GoNextCombatTurn.o: actions/combat/GoNextCombatTurn.cppm $(OBJDIR)/carcer.actions.combat-SetActiveCombatCharacter.o $(OBJDIR)/carcer.game.combat.o $(OBJDIR)/carcer.game.map.o $(OBJDIR)/carcer.state.o | $(OBJDIR)

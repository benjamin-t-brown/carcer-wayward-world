...
$(OBJDIR)/carcer.game.diceHelpers.o: game/diceHelpers.cppm $(OBJDIR)/carcer.model.templates.o | $(OBJDIR)
...
$(OBJDIR)/carcer.runner.o: runner/runner.cppm $(OBJDIR)/carcer.model.templates.o | $(OBJDIR)
...
$(OBJDIR)/carcer.model.instances.World.o: model/instances/World.cppm $(OBJDIR)/carcer.db.o $(OBJDIR)/carcer.model.Combat.o $(OBJDIR)/carcer.model.instances.CharacterInstance.o $(OBJDIR)/carcer.model.instances.MapInstance.o $(OBJDIR)/carcer.model.instances.Player.o $(OBJDIR)/carcer.model.templates.o | $(OBJDIR)
	$(CXX) $(FLAGS) -c model/instances/World.cppm -o $@

$(OBJDIR)/carcer.state.o: state/State.cppm $(OBJDIR)/carcer.db.o $(OBJDIR)/carcer.model.instances.ItemInstance.o $(OBJDIR)/carcer.model.instances.MapInstance.o $(OBJDIR)/carcer.model.instances.Player.o $(OBJDIR)/carcer.model.instances.World.o $(OBJDIR)/carcer.model.templates.o | $(OBJDIR)
...
$(OBJDIR)/carcer.game.map.o: game/map/map.cppm $(OBJDIR)/carcer.db.o $(OBJDIR)/carcer.game.map.TileFields.o $(OBJDIR)/carcer.model.instances.CharacterInstance.o $(OBJDIR)/carcer.model.instances.ItemInstance.o $(OBJDIR)/carcer.model.instances.MapInstance.o $(OBJDIR)/carcer.model.instances.Player.o $(OBJDIR)/carcer.model.instances.World.o $(OBJDIR)/carcer.model.templates.o $(OBJDIR)/carcer.state.o | $(OBJDIR)
...
$(OBJDIR)/carcer.game.combat.o: game/combat/combat.cppm $(OBJDIR)/carcer.db.o $(OBJDIR)/carcer.game.map.o $(OBJDIR)/carcer.model.instances.CharacterInstance.o $(OBJDIR)/carcer.model.instances.Player.o $(OBJDIR)/carcer.model.instances.World.o $(OBJDIR)/carcer.model.templates.o $(OBJDIR)/carcer.state.o | $(OBJDIR)
...
$(OBJDIR)/carcer.ui.components-MapView.o: ui/components/MapView.cppm $(OBJDIR)/carcer.game.map.o $(OBJDIR)/carcer.game.map.TileFields.o $(OBJDIR)/carcer.model.instances.CharacterInstance.o $(OBJDIR)/carcer.model.instances.CharacterPlayer.o $(OBJDIR)/carcer.model.instances.MapInstance.o $(OBJDIR)/carcer.model.instances.World.o $(OBJDIR)/carcer.model.templates.o $(OBJDIR)/carcer.state.o $(OBJDIR)/carcer.ui.core.o | $(OBJDIR)
...
$(OBJDIR)/carcer.ui.pages.PageCharacter.o: ui/pages/PageCharacter.cppm $(OBJDIR)/carcer.actions.ui.UiShowLayerPopupText.o $(OBJDIR)/carcer.model.instances.CharacterPlayer.o $(OBJDIR)/carcer.model.templates.o $(OBJDIR)/carcer.state.o $(OBJDIR)/carcer.ui.core.o $(OBJDIR)/carcer.ui.elements.o $(OBJDIR)/carcer.ui.helpers.o $(OBJDIR)/carcer.ui.layouts.o | $(OBJDIR)
	$(CXX) $(FLAGS) -c ui/pages/PageCharacter.cppm -o $@

$(OBJDIR)/carcer.ui.pages.PageInventory.o: ui/pages/PageInventory.cppm $(OBJDIR)/carcer.model.instances.CharacterPlayer.o $(OBJDIR)/carcer.model.templates.o $(OBJDIR)/carcer.state.o $(OBJDIR)/carcer.ui.ObserverRemoveLayer.o $(OBJDIR)/carcer.ui.components.o $(OBJDIR)/carcer.ui.core.o $(OBJDIR)/carcer.ui.elements.o $(OBJDIR)/carcer.ui.helpers.o $(OBJDIR)/carcer.ui.layouts.o $(OBJDIR)/carcer.ui.lists.o | $(OBJDIR)
...
$(OBJDIR)/carcer.ui.minipages-MinipageEquipRunes.o: ui/minipages/MinipageEquipRunes.cppm $(OBJDIR)/carcer.actions.ui.UiAdjustEquippedRune.o $(OBJDIR)/carcer.actions.ui.UiCancelEquipRunes.o $(OBJDIR)/carcer.actions.ui.UiCommitEquipRunes.o $(OBJDIR)/carcer.model.instances.CharacterPlayer.o $(OBJDIR)/carcer.model.templates.o $(OBJDIR)/carcer.ui.core.o $(OBJDIR)/carcer.ui.elements.o $(OBJDIR)/carcer.ui.helpers.o $(OBJDIR)/carcer.ui.layouts.o $(OBJDIR)/carcer.ui.pages.PageCharacter.o | $(OBJDIR)

...
$(OBJDIR)/carcer.world_updater.o: state/WorldUpdater.cppm $(OBJDIR)/carcer.state.o | $(OBJDIR)
	$(CXX) $(CARCER_BMI_FLAGS) -c state/WorldUpdater.cppm -o $@
...
$(OBJDIR)/carcer.actions.world-WorldSpawnDamageParticle.o: actions/world/WorldSpawnDamageParticle.cppm $(OBJDIR)/carcer.actions.world_effects.o | $(OBJDIR)
	$(CXX) $(CARCER_BMI_FLAGS) -c actions/world/WorldSpawnDamageParticle.cppm -o $@

$(OBJDIR)/carcer.actions.world-WorldSpawnProjectile.o: actions/world/WorldSpawnProjectile.cppm $(OBJDIR)/carcer.actions.world_effects.o | $(OBJDIR)
...
$(OBJDIR)/carcer.actions.combat.o: actions/combat/_combat.cppm $(OBJDIR)/carcer.actions.combat-CharacterSetSpriteIndexOffset.o $(OBJDIR)/carcer.actions.combat-DoCPUCombatTurn.o $(OBJDIR)/carcer.actions.combat-DoCombatAction.o $(OBJDIR)/carcer.actions.combat-DoCombatActionCompletion.o $(OBJDIR)/carcer.actions.combat-EndCombat.o $(OBJDIR)/carcer.actions.combat-GoNextCombatTurn.o $(OBJDIR)/carcer.actions.combat-ModifyAP.o $(OBJDIR)/carcer.actions.combat-ModifyHP.o $(OBJDIR)/carcer.actions.combat-MoveCharacter.o $(OBJDIR)/carcer.actions.combat-PerformCharacterDefeated.o $(OBJDIR)/carcer.actions.combat-PerformMeleeAttack.o $(OBJDIR)/carcer.actions.combat-PerformSpellCast.o $(OBJDIR)/carcer.actions.combat-RemoveCharacterFromMap.o $(OBJDIR)/carcer.actions.combat-SetActiveCombatCharacter.o $(OBJDIR)/carcer.actions.combat-StartCombat.o | $(OBJDIR)

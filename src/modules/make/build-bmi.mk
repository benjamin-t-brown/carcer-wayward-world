...
$(OBJDIR)/carcer.actions-combat.o: actions/combat/combat.cppm $(OBJDIR)/carcer.actions-general.o $(OBJDIR)/carcer.game.combat.o $(OBJDIR)/carcer.game.map.o $(OBJDIR)/carcer.model.templates.o $(OBJDIR)/carcer.state.o | $(OBJDIR)
...
$(OBJDIR)/carcer.actions-world.o: actions/world/world.cppm $(OBJDIR)/carcer.actions-combat.o $(OBJDIR)/carcer.actions-general.o $(OBJDIR)/carcer.game.combat.o $(OBJDIR)/carcer.game.map.o $(OBJDIR)/carcer.state.o | $(OBJDIR)
...
$(OBJDIR)/carcer.ui.minipages-MinipageEquipRunes.o: ui/minipages/MinipageEquipRunes.cppm $(OBJDIR)/carcer.actions.o $(OBJDIR)/carcer.model.instances.o $(OBJDIR)/carcer.model.templates.o $(OBJDIR)/carcer.ui.core.o $(OBJDIR)/carcer.ui.elements.o $(OBJDIR)/carcer.ui.helpers.o $(OBJDIR)/carcer.ui.layouts.o $(OBJDIR)/carcer.ui.pages.PageCharacter.o | $(OBJDIR)
	$(CXX) $(FLAGS) -c ui/minipages/MinipageEquipRunes.cppm -o $@

$(OBJDIR)/carcer.layers.LayerInventory.o: layers/ui/LayerInventory.cppm $(OBJDIR)/carcer.actions.o $(OBJDIR)/carcer.layers.Layer.o $(OBJDIR)/carcer.model.instances.o $(OBJDIR)/carcer.ui.components.o $(OBJDIR)/carcer.ui.helpers.o $(OBJDIR)/carcer.ui.pages.PageInventory.o | $(OBJDIR)
	$(CXX) $(FLAGS) -c layers/ui/LayerInventory.cppm -o $@

$(OBJDIR)/carcer.layers.LayerMagic.o: layers/ui/LayerMagic.cppm $(OBJDIR)/carcer.actions.o $(OBJDIR)/carcer.db.o $(OBJDIR)/carcer.game.combat.o $(OBJDIR)/carcer.layers.Layer.o $(OBJDIR)/carcer.model.instances.o $(OBJDIR)/carcer.model.templates.o $(OBJDIR)/carcer.ui.helpers.o $(OBJDIR)/carcer.ui.pages.PageMagicSetup.o | $(OBJDIR)
